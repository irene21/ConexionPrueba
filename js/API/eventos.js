...
$(function(){
	document.addEventListener("deviceready", function(){
		if(!estaRegistrado())
			window.location.href="#registro"; // si no esta logeado lo que nos hace es redireccionarnos a registro 
		$('#regEnv').tap(function(){
			var nom = $('#regNom').val(); //esta validanddo los valores de entrada del
			var mail = $('#regEma').val();
			var tel = $('#regTel').val();
